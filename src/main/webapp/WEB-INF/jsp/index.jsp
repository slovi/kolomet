		...
		<div id="container"> <!-- hlavní kontejner -->
		    ...
		    <div id="center_container"> <!-- kontejner vystředění - boční menu, kontejner obsahu, patka -->
		    	<div id="side_menu"> <!-- boční menu -->
		        	<div class="side-menu"> <!-- box bočního menu -->
		            	<h1 class="side-menu-header">
		                	Typy kol 
		                	<img class="side-menu-arrow-on" src="img/arrow_down.png " id="TypeArrowDown"/>
		                    <img class="hidden side-menu-arrow-off" src="img/arrow_right.png" onmouseover="javascript:this.src=('img/arrow_right_orange.png');" onmouseout="javascript:this.src=('img/arrow_right.png');" id="TypeArrowRight"/>
		                </h1>
		            ...
		            <div class="side-menu"> <!-- box bočního menu -->
		            	<h1 class="side-menu-header">
		                	Značky kol 
			                <img class="hidden side-menu-arrow-on" src="img/arrow_down.png" id="BrandArrowDown"/>
			                <img class="side-menu-arrow-off" src="img/arrow_right.png" onmouseover="javascript:this.src=('img/arrow_right_orange.png');" onmouseout="javascript:this.src=('img/arrow_right.png');" id="BrandArrowRight"/>
		                </h1>
		                
		            	<ul class="hidden side-menu-body">
		            		<li><a href="">položka bočního menu</a></li>
		                    <li><a href="">položka bočního menu</a></li>
		            	</ul>
		            </div>
