...
privileged aspect ProductColor_Roo_Equals {
    
    public boolean ProductColor.equals(Object obj) {
        ...
        ProductColor rhs = (ProductColor) obj;
    ...
    public int ProductColor.hashCode() {
