...
privileged aspect ApplicationRole_Roo_Equals {
    ...
    public boolean ApplicationRole.equals(Object obj) {
        ...
        return new EqualsBuilder().append(created, rhs.created).append(lastModified, rhs.lastModified).append(roleName, rhs.roleName).isEquals();
    }
    
    public int ApplicationRole.hashCode() {
        return new HashCodeBuilder().append(created).append(lastModified).append(roleName).toHashCode();
    }
