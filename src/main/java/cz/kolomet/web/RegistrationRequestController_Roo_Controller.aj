...
import cz.kolomet.web.RegistrationRequestController;
...
privileged aspect RegistrationRequestController_Roo_Controller {
    ...
    public String RegistrationRequestController.create(@Valid RegistrationRequest registrationRequest, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            ...
            return "admin/registrationrequests/create";
        }
        uiModel.asMap().clear();
    ...
    public String RegistrationRequestController.show(@PathVariable("id") Long id, Model uiModel) {
    ...
    public String RegistrationRequestController.list(@RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
        if (page != null || size != null) {
            ...
            uiModel.addAttribute("registrationrequests", registrationRequestService.findRegistrationRequestEntries(firstResult, sizeNo));
            float nrOfPages = (float) registrationRequestService.countAllRegistrationRequests() / sizeNo;
