...
import cz.kolomet.web.RateController;
...
privileged aspect RateController_Roo_Controller {
    ...
    public String RateController.list(@RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
